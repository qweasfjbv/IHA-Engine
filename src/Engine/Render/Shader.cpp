...
bool IHA::Engine::Shader::Load(const std::wstring& vsPath, const std::wstring& psPath, ID3D12Device* device)
{
    HRESULT hr;
...
void IHA::Engine::Shader::Bind(ID3D12GraphicsCommandList* cmd)
{
